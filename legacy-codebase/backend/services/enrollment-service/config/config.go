...
// Config holds all configuration for the enrollment service
type Config struct {
...
func Load() (*Config, error) {
	...
	config.SetCommonDefaults("enrollment", config.EnrollmentServicePort, config.EnrollmentDBPort)
	...
	if err := config.SetupViper("enrollment-service"); err != nil {
		return nil, err
	}
