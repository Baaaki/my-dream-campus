...
JOIN staff s ON tp.staff_id = s.id
WHERE tp.staff_id = $1 AND s.is_active = true
LIMIT 1;

-- name: CreateTeacherProfile :one
INSERT INTO teacher_profiles (staff_id, academic_title, faculty, profile_image_url)
VALUES ($1, $2, $3, $4)
...
DELETE FROM teacher_profiles WHERE staff_id = $1;
