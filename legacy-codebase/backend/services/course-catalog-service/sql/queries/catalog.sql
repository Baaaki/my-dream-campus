...
WHERE (sqlc.narg('faculty')::text IS NULL OR faculty = sqlc.narg('faculty'))
  ...
  AND (sqlc.narg('course_category')::course_category_enum IS NULL OR course_category = sqlc.narg('course_category'))
  AND (sqlc.narg('education_level')::education_level_enum IS NULL OR education_level = sqlc.narg('education_level'))
