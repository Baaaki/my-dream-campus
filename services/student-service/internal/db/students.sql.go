...
func (q *Queries) BulkAssignAdvisor(ctx context.Context, arg BulkAssignAdvisorParams) error {
	_, err := q.db.Exec(ctx, bulkAssignAdvisor, arg.Column1, arg.AdvisorID)
	return err
}
...
func (q *Queries) GetStudentByNumber(ctx context.Context, studentNumber string) (Student, error) {
...
func (q *Queries) ListOrphanedStudents(ctx context.Context, arg ListOrphanedStudentsParams) ([]Student, error) {
...
func (q *Queries) ListStudentsByAdvisor(ctx context.Context, advisorID pgtype.UUID) ([]Student, error) {
...
func (q *Queries) ListStudentsByDepartment(ctx context.Context, department string) ([]Student, error) {
